...
public class ConfigureIntakeClientOptions : IConfigureOptions<IntakeClientOptions>
{
    ...
    private readonly INotificationApiUrlProvider _urlProvider;

    public ConfigureIntakeClientOptions(INotificationApiUrlProvider urlProvider, IConfiguration configuration)
    {
