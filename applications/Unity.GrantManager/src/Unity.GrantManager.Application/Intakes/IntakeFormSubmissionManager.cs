        ...
        {            
            ...
            var application = await _applicationRepository.InsertAsync(
                new Application
                {
                    ...
                    ProjectStartDate = MappingUtil.ConvertDateFromChefsFormat(intakeMap.ProjectStartDate),
                    ProjectEndDate = MappingUtil.ConvertDateFromChefsFormat(intakeMap.ProjectEndDate),
