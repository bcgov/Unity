...
$(function () {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return '<button class="btn btn-link p-0 delete-link-btn" data-link-id="' + data + '" title="Delete Link" style="color: #0066cc; text-decoration: none;"><i class="fa-solid fa-xmark"></i></button>';
                    },
                    orderable: false
                }
            ],
    ...
    const UIService = {
                ...
                if (summaryContainer.length) {
                    ...
                    const summaryHtml = `
                        <div id="validationSummaryContainer" class="validation-summary alert alert-danger" role="alert">
                            <i class="fa-solid fa-triangle-exclamation validation-summary-icon"></i>
        ...
        buildErrorIcon: function() {
            return '<span class="link-error-icon ms-2" title="Failed to load complete details. The link will still be created with available information."><i class="fa-solid fa-triangle-exclamation"></i></span>';
        },
        ...
        buildValidationErrorHtml: function(link) {
            ...
            return `
                <div class="validation-error-message">
                    <i class="fa-solid fa-circle-exclamation validation-error-icon"></i>
