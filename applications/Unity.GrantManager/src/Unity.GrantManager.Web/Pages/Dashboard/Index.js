...
function reloadDashboard() {
    ...
    unity.grantManager.dashboard.dashboard.getApplicationAssigneeCount(params.intakeIds, params.categories, params.statusCodes, params.substatus).then(applicationAssignees => {
