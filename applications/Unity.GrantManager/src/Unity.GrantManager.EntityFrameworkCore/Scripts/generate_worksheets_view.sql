...
BEGIN
    ...
    EXECUTE format('CREATE VIEW "Reporting".%I AS SELECT "Id", "CorrelationId", "CorrelationProvider", %s FROM (SELECT "Id", "CorrelationId", "CorrelationProvider", "ReportData" FROM "Flex"."WorksheetInstances" WHERE "Flex"."WorksheetInstances"."WorksheetId" = %L) AS subquery',
        view_name,
        select_clause,
        table_a_id
    );
