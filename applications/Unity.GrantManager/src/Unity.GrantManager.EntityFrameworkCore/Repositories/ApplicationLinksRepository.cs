...
namespace Unity.GrantManager.Repositories
{
    ...
    [ExposeServices(typeof(IApplicationLinksRepository))]
#pragma warning disable CS8613 // Nullability of reference types in return type doesn't match implicitly implemented member.
    // This pattern is an implementation ontop of ABP framework, will not change this
    public class ApplicationLinksRepository : EfCoreRepository<GrantTenantDbContext, ApplicationLinks, Guid>, IApplicationLinksRepository
