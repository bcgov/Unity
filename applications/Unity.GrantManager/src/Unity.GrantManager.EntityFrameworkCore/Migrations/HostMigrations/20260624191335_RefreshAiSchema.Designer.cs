...
namespace Unity.GrantManager.Migrations.HostMigrations
{
    ...
    [Migration("20260624191335_RefreshAiSchema")]
    partial class RefreshAiSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unity.AI.Domain.AIPrompt", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .HasDatabaseName("IX_AIPrompts_Name");
            ...
            modelBuilder.Entity("Unity.GrantManager.Messaging.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Volo.Abp.AuditLogging.AuditLogExcelFile", b =>
                {
                    ...
                    b.ToTable("AuditLogExcelFiles", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.PermissionManagement.ResourcePermissionGrant", b =>
                {
                    ...
                    b.ToTable("ResourcePermissionGrants", (string)null);
                });
