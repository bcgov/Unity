...
namespace Unity.GrantManager.Migrations.TenantMigrations
{
    ...
    [Migration("20260818204457_AB33234_ExternalLinksApplicantMessage")]
    partial class AB33234_ExternalLinksApplicantMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unity.GrantManager.Applications.Applicant", b =>
                {
                    ...
                    b.Property<string>("ReportsComments")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Unity.GrantManager.Applications.ApplicantAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Unity.GrantManager.Applications.ApplicationForm", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "ExternalLinksConfig", "Unity.GrantManager.Applications.ApplicationForm.ExternalLinksConfig#ExternalLinksConfig", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<string>("ApplicantMessage")
                                .IsRequired()
                                .HasMaxLength(512);

                            b1.ComplexCollection(typeof(List<Dictionary<string, object>>), "Links", "Unity.GrantManager.Applications.ApplicationForm.ExternalLinksConfig#ExternalLinksConfig.Links#ExternalLink", b2 =>
                                {
                                    b2.IsRequired();
                                    ...
                                    b2.Property<int>("ExternalLinkType");

                                    b2.Property<int>("Order");

                                    b2.Property<bool>("Published");
            ...
            modelBuilder.Entity("Unity.GrantManager.Applications.ReportsHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool?>("IncompleteReport")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("ReportsHistories", (string)null);
                });
            ...
            modelBuilder.Entity("Unity.GrantManager.Comments.ApplicantComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ApplicantComments", (string)null);
                });
