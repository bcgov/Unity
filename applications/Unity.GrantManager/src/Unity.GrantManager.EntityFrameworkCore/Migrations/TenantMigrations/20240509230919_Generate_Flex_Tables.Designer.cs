...
namespace Unity.GrantManager.Migrations.TenantMigrations
{
    ...
    [Migration("20240509230919_Generate_Flex_Tables")]
    partial class Generate_Flex_Tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Scoresheets.QuestionValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Scoresheets.ScoresheetInstance", b =>
                {
                    ...
                    b.ToTable("ScoresheetInstances", (string)null);
                });
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Scoresheets.ScoresheetSection", b =>
                {
                    ...
                    b.ToTable("ScoresheetSections", (string)null);
                });
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Worksheets.CustomFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Worksheets.WorksheetInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WorksheetInstances", (string)null);
                });
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Worksheets.WorksheetSection", b =>
                {
                    ...
                    b.ToTable("WorksheetSections", (string)null);
                });
            ...
            modelBuilder.Entity("Unity.Flex.Domain.Worksheets.CustomFieldValue", b =>
                {
                    b.HasOne("Unity.Flex.Domain.Worksheets.CustomField", "CustomField")
                        .WithMany("Values")
