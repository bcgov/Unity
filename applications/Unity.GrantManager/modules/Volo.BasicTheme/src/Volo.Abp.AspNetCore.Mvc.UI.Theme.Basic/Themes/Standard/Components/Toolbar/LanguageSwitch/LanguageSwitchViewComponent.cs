...
namespace Unity.AspNetCore.Mvc.UI.Themes.Standard.Components.Toolbar.LanguageSwitch;
...
public class LanguageSwitchViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View("~/Themes/Standard/Components/Toolbar/LanguageSwitch/Default.cshtml", model);
    }
}
