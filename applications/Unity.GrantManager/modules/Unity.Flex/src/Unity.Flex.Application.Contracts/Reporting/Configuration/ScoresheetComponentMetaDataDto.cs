...
{
    public class ScoresheetComponentMetaDataDto
    {
        /// <summary>
        /// List of components metadata in the worksheet
        /// </summary>
        public List<ScoresheetComponentMetaDataItemDto> Components { get; set; } = [];
    }

    public class ScoresheetComponentMetaDataItemDto
    {
        /// <summary>
