        ...
        public static string Resolve(CustomFieldType type, object? definition)
        {
            ...
            else if (definition is JsonElement element)
            {
                return type switch
                {
                    CustomFieldType.Undefined => "{}",
                    CustomFieldType.BCAddress => "{}",
                    CustomFieldType.Numeric => element.GetRawText(),
                    CustomFieldType.Text => element.GetRawText(),
                    CustomFieldType.Date => element.GetRawText(),
                    CustomFieldType.DateTime => element.GetRawText(),
                    CustomFieldType.Currency => element.GetRawText(),
                    CustomFieldType.YesNo => element.GetRawText(),
                    CustomFieldType.Email => element.GetRawText(),
                    CustomFieldType.Phone => element.GetRawText(),
                    CustomFieldType.Radio => element.GetRawText(),
                    CustomFieldType.Checkbox => element.GetRawText(),
                    CustomFieldType.CheckboxGroup => element.GetRawText(),
                    CustomFieldType.SelectList => element.GetRawText(),
                    CustomFieldType.TextArea => element.GetRawText(),
                    CustomFieldType.DataGrid => element.GetRawText(),
                    _ => throw new NotImplementedException(),
                };
            }
