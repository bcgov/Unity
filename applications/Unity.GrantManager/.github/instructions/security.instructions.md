...
Apply the repository-wide guidance from `../copilot-instructions.md` to all security-sensitive code.
...
- Store sensitive configuration in Keycloak, Azure Key Vault, or equivalent
